 ...
 * 右侧字母选择
 */
public class SideLetterBarWithoutHot extends View {
    ...
    public SideLetterBarWithoutHot(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public SideLetterBarWithoutHot(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SideLetterBarWithoutHot(Context context) {
        super(context);
    }
